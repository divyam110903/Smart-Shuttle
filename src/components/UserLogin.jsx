...
const UserLogin = ({ switchToAdmin }) => {
  ...
  const [username, setUsername] = useState("user@mail.com");
  const [password, setPassword] = useState("@user2003");
      ...
      <div className="flex p-6 max-w-3xl w-full">
        ...
        <div className="w-1/2 p-8 max-w-[400px] bg-[#FBFBFB]">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <button type="submit" className="w-full bg-blue-500 text-white text-lg font-medium p-3 rounded-lg hover:bg-blue-600 transition-colors mt-6">
              Login
            </button>
          </form>
